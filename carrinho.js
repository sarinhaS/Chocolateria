...
const addCartToHTML = () => {
    ...
    if (cart.length > 0) {
        cart.forEach(item => {
            ...
            let name = productElement.querySelector('h2').innerText;
            let price = parseFloat(productElement.querySelector('.price').innerText.replace('$', ''));
            ...
            newItem.innerHTML = `
                ...
                <div class="totalPrice">$${price * item.quantity}</div>
                <div class="quantity">
